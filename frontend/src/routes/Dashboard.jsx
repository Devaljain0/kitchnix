...
export default function Dashboard() {
  ...
  const handleShopNowClick = () => {
    navigate('/allrecipes'); // Navigate to the AllRecipes page
  };
    ...
    <div className="min-h-screen bg-green-500 w-full">
      ...
      <div className="h-screen flex justify-between items-center py-20 bg-green-600 text-white w-full px-8">
        ...
        <div className="text-center flex-1">
          ...
          <button
            className="mt-4 bg-white text-green-600 px-6 py-2 rounded"
            onClick={handleShopNowClick} // Add click handler to navigate
          >
            All Recipes
          </button>
        </div>
